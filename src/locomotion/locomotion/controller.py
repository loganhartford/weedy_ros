...
class ControllerNode(Node):
    def __init__(self, klp=1.3, kld=0, kli=1.0, kap=0.2, kad=0.2, kai=0.2):
        ...
        self.linear_pid=PID_ctrl(klp, kld, kli)
        self.angular_pid=PID_ctrl(kap, kad, kai)
    ...
    def control_loop(self):
        ...
        # Open loop velocity control with gain scheduling
            ...
            # Update last velocities for filtering
